...
parser.add_argument("--num-epochs", type=int, default=12)  # 12ep fits under 1hr with EMA
...
ADAM_BETAS = (0.8, 0.95)
WARMUP_RATIO = 0.0
WARMDOWN_RATIO = args.warmdown_ratio if args.warmdown_ratio is not None else 0.4
FINAL_LR_FRAC = 0.0
